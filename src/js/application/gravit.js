(function (_) {
    ...
    Gravit.prototype.init = function () {
        ...
        gravit.actions.push(
            ...
            new GAlignAction(GEditor.ArrangeAlignType.AlignLeft),
            new GAlignAction(GEditor.ArrangeAlignType.AlignCenter),
            new GAlignAction(GEditor.ArrangeAlignType.AlignRight),
            new GAlignAction(GEditor.ArrangeAlignType.AlignJustifyHorizontal),
            new GAlignAction(GEditor.ArrangeAlignType.AlignTop),
            new GAlignAction(GEditor.ArrangeAlignType.AlignMiddle),
            new GAlignAction(GEditor.ArrangeAlignType.AlignBottom),
            new GAlignAction(GEditor.ArrangeAlignType.AlignJustifyVertical),
